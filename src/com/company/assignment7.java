...
public class assignment7 {
    ...
    public static void main(String[] args) {
        ...
        if (method == 1) {
            //method 1
            System.out.println("\nThis is method 1, used for and foreach loop :\n");
            ...
            //method 2
            System.out.println("\nThis is method 2, used only foreach loop:\n");
            for (int number : numbers) {
                int random = (int) (Math.random() * 6 + 1);
                number = random;
                System.out.print(number + " ");
        ...
        //assignment 7.3
        System.out.println("Assignment 7.3");
        ...
        for (double count : array3){
            counter2 += count;
        }

        divided = counter2 / array3.length;
        ...
        System.out.println("\nYour average is " + divided);
        System.out.println("there are " + higher + " numbers higher than the average");
